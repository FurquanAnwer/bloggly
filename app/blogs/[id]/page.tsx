...
const page = ({ params }: { params: Promise<{ id: string }> }) =>{
    ...
    return (
        ...
        <div className='mx-5 max-w-[800px] md:mx-auto mt-[-100px] mb-10'>
            <Image src={data.image} className='border-4 border-white' width={1280} height={720}/>
            <h1 className='my-8 text-[26px] font-semibold'>Introduction:</h1>
            <p>{data.description}</p>
            <h3 className='my-5 text-[18px] font-semibold'>Step 1: Self-Reflection and Goal Setting</h3>
            <p className='my-3'>Before you can manage your lifestyle, you must have a clear understanding of what you want to achieve in your life.</p>
            <p className='my-3'>Before you can manage your lifestyle, you must have a clear understanding of what you want to achieve in your life.</p>
